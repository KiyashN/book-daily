    ...
    <div className='holder'>
        <header className='header'>
            ...
            <div className='header-content flex flex-c text-center text-white'>
                <h2 className='header-title text-capitalize' >welcome reader
                <svg xmlns="http://www.w3.org/2000/svg"  width="48" height="48" fill="currentColor" class="bi bi-emoji-smile" viewBox="-5 -5 21 21" >
                ...
                <p className='header-text fs-18 fw-3' >There you can find your book</p>
                <SearchForm />
            </div>
        </header>
    </div>
